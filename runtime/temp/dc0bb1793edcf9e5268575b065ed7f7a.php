<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:103:"D:\Web\phpStudy\PHPTutorial\WWW\02.Frame\tp5.0-blog\public/../application/backend\view\login\index.html";i:1531971160;}*/ ?>
        	...
        	<div class="col-md-4 col-md-offset-4">
    			...
    			<form action="" method="post" class="form-horizontal">
                	<div class="form-group">
                		...
                		<div class="col-sm-8">
                    		<input type="text" name="username" calss="form-control">
                    	</div>
                	</div>
             		...
             		<div class="form-group">
             			...
             			<div class="col-sm-8">
                    		<input type="password" name="password" calss="form-control">
                    	</div>
                    </div>
                    <div class="form-group">
             			<div class="col-sm-4 col-sm-offset-4">
                    		<button style="submit" class="btn btn-primary btn-block">登录</button>
                    	</div>
                    </div>
                 </form>
             </div>
