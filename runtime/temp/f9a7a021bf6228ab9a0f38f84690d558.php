<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:101:"D:\Web\phpStudy\PHPTutorial\WWW\02.Frame\tp5.0-blog\public/../application/backend\view\post\edit.html";i:1532931716;s:92:"D:\Web\phpStudy\PHPTutorial\WWW\02.Frame\tp5.0-blog\application\backend\view\common\app.html";i:1532959121;}*/ ?>
<!DOCTYPE html>
<html lang="ch">
...
<div class="col-sm-12">
    <form action="" method="post" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="title" class="form-control" placeholder="请输入标题" value="<?php echo $post->title; ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <label style="margin-top:8px">
                    <input type="checkbox" name="tags[]" value="<?php echo $tag->id; ?>" <?php echo $post->hasTag($tag->id)?'checked':''; ?>><?php echo $tag->name; ?>
                </label>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
            	<textarea name="content" class="form-control" placeholder="请输入内容" rows="30" cols="30"><?php echo $post->content; ?>
                </textarea>
            </div>
        </div>
