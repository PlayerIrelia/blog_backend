<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:100:"D:\Web\phpStudy\PHPTutorial\WWW\02.Frame\tp5.0-blog\public/../application/backend\view\tag\edit.html";i:1532529881;s:92:"D:\Web\phpStudy\PHPTutorial\WWW\02.Frame\tp5.0-blog\application\backend\view\common\app.html";i:1532952398;}*/ ?>
<!DOCTYPE html>
<html lang="ch">
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> 登录账号 <b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-fw fa-gear"></i> 设 置(Settings)</a>
                        </li>
                        <li class="divider"></li>
                        <li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Tags Management <small> Tags Management (标签管理)</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            添加标签.当前时间 : <?php echo date('Y.m.d H:i:s'); ?>
                        </div>
                    </div>
                </div>
                <!-- /.row -->
                	...
                	<div class="col-lg-6 col-md-6">
                        <form role="form" action="" method="post">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" maxlength="12" name="name" placeholder="请输入需要创建的标签名称" value="<?php echo $tag->name; ?>">
                          </div>
