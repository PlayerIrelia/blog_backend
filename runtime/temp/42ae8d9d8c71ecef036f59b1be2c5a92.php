<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:105:"D:\Web\phpStudy\PHPTutorial\WWW\02.Frame\tp5.0-blog\public/../application/backend\view\setting\index.html";i:1533003996;s:92:"D:\Web\phpStudy\PHPTutorial\WWW\02.Frame\tp5.0-blog\application\backend\view\common\app.html";i:1532959121;}*/ ?>
<!DOCTYPE html>
<html lang="ch">
...
<div class="col-sm-12">
    <form action="" method="post" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="web_name" class="form-control" placeholder="请输入网站名称" value="<?php echo $setting->_get('web_name'); ?>">
            </div>
        </div>

        <div class="form-group">
            <label class="control-label col-sm-1">域 名：</label>
            <div class="col-sm-10">
                <input type="text" name="web_domain" class="form-control" placeholder="请输入域名" value="<?php echo $setting->_get('web_domain'); ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="seo_keywords" class="form-control" placeholder="请输入关键字" value="<?php echo $setting->_get('seo_keywords'); ?>">
            </div>
        </div>

        <div class="form-group">
            <label class="control-label col-sm-1">描 述：</label>
            <div class="col-sm-10">
            	<textarea name="seo_description" class="form-control" placeholder="请输入内容" rows="10" cols="30"><?php echo $setting->_get('seo_description'); ?>
                </textarea>
            </div>
        </div>

        <div class="form-group">
            <label class="control-label col-sm-1">备案信息：</label>
            <div class="col-sm-10">
                <input type="text" name="web_icp" class="form-control" placeholder="请输入备案信息" value="<?php echo $setting->_get('web_icp'); ?>">
            </div>
        </div>
